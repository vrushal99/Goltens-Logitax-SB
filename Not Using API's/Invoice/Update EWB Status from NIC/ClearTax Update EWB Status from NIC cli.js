...
define(["N/record", "N/currentRecord", "N/format", 'N/search', 'N/ui/message', 'N/url'], function(record, currentRecord, format, search, message, url) {
	...
	function callClearTaxEWB_from_NIC() {
		try {
			...
			var s_sut_url = url.resolveScript({   // call suitelet script
				scriptId: "customscript_cleartax_ewb_status_frm_nic",
				deploymentId: "customdeploy_cleartax_ewb_status_frm_nic"
			    });
    ...
    //End: callClearTaxEWB_from_NIC functionality 
	...
	return {
		pageInit: pageInit,
		callClearTaxEWB_from_NIC: callClearTaxEWB_from_NIC
	}
