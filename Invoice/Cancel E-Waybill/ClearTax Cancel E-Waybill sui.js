/*----------------------------------------------------------------------------------------------
        ...
        Script Name 	:	ClearTax Cancel E-Waybill sui
        Author 			:  	NVT Employee 
        Date            :   03-07-2024
        Description		:  
            ...
            try {
                ...
                if (nullCheck(ewaybill_no) && !nullCheck(ewaybill_cancel_irn)) {
                    ...
                    invoice_obj.setValue({
                        fieldId: 'custbody_logitax_cancel_ebill_request',
                    ...
                    if (response.code == 200) {
                        ...
                        if (error == "true" || error == true) {
                            ...
                            var cancelEwbDate = parseObdy[0]["cancelDate"];
