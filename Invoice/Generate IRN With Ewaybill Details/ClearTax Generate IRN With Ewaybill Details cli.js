/*----------------------------------------------------------------------------------------------
        ...
        Script Name 	:	ClearTax Generate IRN Ewaybill Detl cli
        Author 			:  	NVT Employee 
        Date            :   05-07-2024
        Description		:   
    ...
    function ClearTax_Generate_IRN_With_Ewaybill_Cli() {
        try {
            ...
            var s_sut_url = url.resolveScript({   // call suitelet script
                scriptId: "customscript_cleartax_gen_irn_ewayde_sui",
                deploymentId: "customdeploy_cleartax_gen_irn_ewayde_sui"
            });
