			...
			try {
				...
				if (typeOdMode == "view") {
					...
					if (recordType == "invoice") {
						...
						form.clientScriptModulePath = '/SuiteScripts/ClearTax Integration Scripts/ClearTax Initiate Multi-Vehicle E-Waybills cli.js';  // this path is call to client script
					}
				}
			} catch (ex) {
				log.debug({
