	...
	function ClearTax_Update_E_Waybill_Transporter_ID_ues(context) {
		try {
			...
			if (typeOdMode == "view") {
				...
				form.clientScriptModulePath = '/SuiteScripts/ClearTax Integration Scripts/ClearTax Update E-Waybill Transporter ID cli.js';  // this path is call to client script
			}
		} catch (ex) {
			log.debug({
				title: 'ex:',
